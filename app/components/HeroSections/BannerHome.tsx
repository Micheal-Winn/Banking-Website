  ...
  return (
    ...
    >
      <div className=" sm:w-full md:w-[45%] flex  flex-col gap-9 xl:pt-16 lg:pt-10 lg:pl-14 md:pt-8 md:pl-6 sm:pt-6 sm:pl-4 pl-3 pr-4">
        <motion.div initial="hidden" whileInView={"show"} variants={textContainer} className="text-[#0E1446] text-center md:text-left 2xl:text-[5rem] xl:text-7xl lg:text-[3.2rem] md:text-[2.6rem] sm:text-7xl text-[2.4rem] md:leading-tight  md:tracking-wider xl:tracking-wider lg:tracking-wider  leading-tight font-bold tracking-wide">
