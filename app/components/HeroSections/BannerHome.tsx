...
const BannerHome = () => {
  return (
    <section className=" flex xl:container sm:pt-6 md:pt-8 lg:pt-8 xl:pt-24 2xl:pt-36 flex-col-reverse md:flex-row gap-4 md:gap-0">
      <div className=" sm:w-full md:w-[45%] flex  flex-col gap-9 xl:pt-16 lg:pt-10 lg:pl-14 md:pt-8 md:pl-6 sm:pt-6 sm:pl-4 pl-3 pr-4">
        ...
        <p className="text-[#C9D0DD] text-center md:text-left 2xl:text-xl xl:text-lg lg:text-base md:text-sm sm:text-[1rem] text-sm w-[96%] sm:w-[80%] mx-auto md:mx-0 md:w-full lg:w-[85%] sm:leading-6 md:leading-8">
          It's time to make the world of finance simpler, smarter and fit for
