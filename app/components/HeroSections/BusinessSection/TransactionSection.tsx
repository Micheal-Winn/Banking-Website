...
const TransactionSection = () => {
  return (
    <section className="flex container h-auto sm:pl-10 md:pl-5 flex-col-reverse md:flex-row">
      ...
      <div className="h-[300px] sm:h-[350px] md:h-[400px] xl:h-[460px] w-full  lg:w-[60%] xl:pt-16">
